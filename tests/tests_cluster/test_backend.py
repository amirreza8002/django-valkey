...
class TestDjangoValkeyCache:
    ...
    def test_hmget(self, cache: ClusterValkeyCache):
        cache.hset("foo_hash1", mapping={"foo1": "bar1", "foo2": "bar2"})
    ...
    def test_hgetall(self, cache: ClusterValkeyCache):
        cache.hset("foo_hash1", "foo1", "bar1")
        cache.hset("foo_hash1", "foo2", 2)
        cache.hset("foo_hash1", "foo3", 3.1)
    ...
    def test_hincrby(self, cache: ClusterValkeyCache):
    ...
    def test_hincrbyfloat(self, cache: ClusterValkeyCache):
    ...
    def test_hstrlen(self, cache: ClusterValkeyCache):
    ...
    def test_sintercard(self, cache: ClusterValkeyCache):
        cache.sadd("{set}1", "a", "b", "c")
        cache.sadd("{set}2", "b", "c", "d")
        assert cache.sintercard("{set}1", "{set}2") == 2
        assert cache.sintercard("{set}1", "{set}2", limit=1) == 1
